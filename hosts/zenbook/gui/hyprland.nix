  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bind = [
        ...
        "CTRL ALT, F1, exec, /run/wrappers/bin/chvt 1"
        "CTRL ALT, F2, exec, /run/wrappers/bin/chvt 2"
        "CTRL ALT, F3, exec, /run/wrappers/bin/chvt 3"
        "CTRL ALT, F4, exec, /run/wrappers/bin/chvt 4"
        "CTRL ALT, F5, exec, /run/wrappers/bin/chvt 5"
        "CTRL ALT, F6, exec, /run/wrappers/bin/chvt 6"
        "CTRL ALT, F7, exec, /run/wrappers/bin/chvt 7"
        "ALT, Return, exec, ${pkgs.ghostty}/bin/ghostty"
        "ALT, D, exec, ${pkgs.walker}/bin/walker"
        "ALT SHIFT, E, exec, ${pkgs.wlogout}/bin/wlogout"
