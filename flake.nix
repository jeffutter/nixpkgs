    ...
    let
      ...
      claudeCodeOverlay =
        ...
        let
          ...
          claudeCodeChecksums = {
            "darwin-arm64" = "sha256-JNjfi0b1hrNN4FJ4Xf5IsbhyU+KYqn3u/pARV0IgOjQ=";
            "darwin-x64" = "sha256-6RhsWW+pSrOCgdSOTWPeQJryFpMhDaa8Xi6L41mrGv0=";
            "linux-arm64" = "sha256-hxOSSrbg1qiHWC+mzppgw7uLP3OT+E/aPDsQgVCDpbw=";
            "linux-x64" = "sha256-Sj+MADP1zhy7ZFSpHaV+CigHNydy9L+suNUNn3ftkzE=";
          };
