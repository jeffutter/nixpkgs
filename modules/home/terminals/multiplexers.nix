  ...
  programs.tmux = {
    ...
    extraConfig =
      ''
        ...
        set -g status-right "#[fg=${c.base0D},bg=${c.base00}]#{prefix_highlight}#[fg=${c.base01},bg=${c.base00}]#(gitmux -cfg ${gitmuxConfig} \"#{pane_current_path}\")#[bg=${c.base01}] #[fg=${c.base02},bg=${c.base01}]#[fg=${c.base05},bg=${c.base02}]  #(${shortenPath} \"#{pane_current_path}\") #[fg=${c.base03},bg=${c.base02}]#(${kubeContext})#[fg=${c.base04},bg=${c.base03}]#[fg=${c.base00},bg=${c.base04}] %Y-%m-%d  %I:%M %p #[fg=${c.base0D},bg=${c.base04}]#[fg=${c.base00},bg=${c.base0D},bold] #h "
