...
before packages are loaded."
  ...
  (with-eval-after-load 'lsp-mode
    (add-to-list 'lsp-file-watch-ignored ".elixir-ls$")
    (add-to-list 'lsp-file-watch-ignored "deps$")
    (add-to-list 'lsp-file-watch-ignored "_builds$")
    )
